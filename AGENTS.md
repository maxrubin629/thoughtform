...
- Paper committed material follows `designs/pearlescent-liquid-paper.png`: a coral pearlescent gel with continuous highlights across lobe-stem junctions, a subtle living sheen at rest, and a static shader when reduced motion is enabled. This shader treatment is Paper-only; Nocturne keeps its existing material.
